...
function WinLose(){
    ...
    <div className="App">
      <div className="black-nav">
        <div>League of legend winning rate predict</div>
      </div>
        <TextArea rows={5} placeholder="name님이 로비에 참가하셨습니다.... name2님이 로비에 참가하셨습니다. ..." onChange={e=>{setSummoners({input_text: e.target.innerHTML})}} />
        <button onClick={click2}>소환사 검색</button>
        ...
        <button onClick={click}>승률 예측</button>
        {/*<Tooltip title="승률예측">*/}
